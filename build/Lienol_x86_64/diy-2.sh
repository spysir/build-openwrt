...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='xiaomi-ac2100'' package/default-settings/files/zzz-default-settings

# 内核显示增加自己个性名称和编译日期（281677160 build $(TZ=UTC-8 date "+%Y.%m.%d") @ 这些为后期增加）
